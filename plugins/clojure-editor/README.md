...
Scoped text-editing companion for Clojure workflows. Use when: editing non-Clojure files such as Markdown, JSON, YAML, EDN config, README files, plugin metadata, or editing/removing existing top-level Clojure line-comment blocks. Not for Clojure forms or structural Clojure edits.
