...
λ structural_tools_mandatory.
  ...
  | new_top_level_comments_with_form_edits → in_scope
  | existing_standalone_zero_depth_line_comment_edits ∨ standalone_non_form_content_edits → out_of_scope ∧ report_needs(Non-Clojure-Editor)
